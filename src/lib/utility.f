C take from POTLIB 2001. all non warninig output removed
      SUBROUTINE POTINFO
C
C***********************************
C                                  *
...
!01   FORMAT(2x,' MAX. AND ACTUAL NO. OF EXCITED SURFACES: ',I3,5x,I3)
...
!03   FORMAT(2x,' MAX. AND ACTUAL ORDER OF DERIVATIVES:    ',I3,5x,I3)
...
C
!         WRITE(NFLAG(18),1000) ICARTR
!000      FORMAT(2X,' WRONG ICARTR FOR DERIVATIVE; ICARTR =',I5//)
!         STOP
C
      ENDIF
C
